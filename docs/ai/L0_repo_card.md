# agora-murf-voice-agent (python) — Repo Card

> Next.js web client + Python FastAPI backend for a fixed Sarvam STT, managed OpenAI, and Murf TTS voice agent.

## Identity

| Field         | Value                                                                |
| ------------- | -------------------------------------------------------------------- |
| Repo          | `agora-murf-voice-agent`                                              |
